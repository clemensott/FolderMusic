    ...
    public sealed class Background : IBackgroundTask
    {
        ...
        private async void SetSong()
        {
            try
            {
                ...
                string path = @"C:\Data\Users\Public\Music\Music\Halfbrick - Jetpack Joyride.mp3";
        ...
        private void UpdateSystemMediaTransportControl()
        {
            ...
            systemMediaTransportControl.DisplayUpdater.MusicProperties.Title = "Jetpack Joyride";
            systemMediaTransportControl.DisplayUpdater.MusicProperties.Artist = "Halfbrick";
