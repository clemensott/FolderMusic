...
namespace MusicPlayer.Data.Shuffle
{
    class ShuffleOneTime : IShuffle
    {
        ...
        public static IShuffle Instance
        {
            get
            {
                if (instance == null) instance = new ShuffleOneTime();
        ...
        private void InsertSongAtRandomIndex(Song song, List<int> shuffleList, IList<Song> updatedSongs)
        {
