...
namespace MusicPlayerLib
{
    class ForegroundCommunicator
    {
        ...
        public static void SendSongsIndexAndShuffleIfComplete()
        {
            ...
            if (Library.ViewModel.CurrentPlaylist.Shuffle == ShuffleKind.Complete)
            {
                ...
                valueSet.Add("ShuffleList", XmlConverter.Serialize(Library.Current.CurrentPlaylist.ShuffleSongs));
            }
            else 
        ...
        private static void GetPlaylistsAndSongsIndex(ValueSet valueSet)
        {
            ...
            BackgroundAudioTask.Current.SetCurrentSong(BackgroundAudioTask.Current.IsPlaying);
        }
