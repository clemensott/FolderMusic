    ...
    public class Playlist : INotifyPropertyChanged
    {
        ...
        public int SongsIndex
        {
            ...
            set
            {
                ...
                if (!IsEmptyOrLoading)
                {
                    UpdateShuffleListBecauseOfChangedSongIndex(value);
                ...
                if (Library.Current.IsForeground) BackgroundCommunicator.SendPlaylistsAndSongsIndexAndShuffleIfComplete(this);
        ...
        public void GenerateShuffleList()
        {
            ...
            {
                Library.ViewModel.SetScrollLbxCurrentPlaylist();
        ...
        private void UpdateAndSendToBackground()
        {
            ...
            UpdateCurrentSongIndex();
            UpdateSongCount();
            Library.ViewModel.UpdateCurrentSong();
