...
namespace LibraryLib
{
    public class Library
    {
        ...
        public static ViewModel ViewModel { get { return Current as ViewModel; } }
        ...
        public int CurrentPlaylistIndex
        {
            ...
            set
            {
                ...
                if (isForeground)
                {
                    ViewModel.SetScrollLbxCurrentPlaylist();
                    ViewModel.UpdateCurrentPlaylistIndexAndRest();
        ...
        public async Task LoadAsync()
        {
            ...
            if (!isForeground) ForegroundCommunicator.SendXmlText();
        }
        ...
        public async static Task AddSkipSongAndSave(Song song)
        {
            ...
            if (!Current.isForeground) ForegroundCommunicator.SendSkip();
        }
        ...
        public void Delete(Playlist playlist)
        {
            ...
            if (isForeground) BackgroundCommunicator.SendRemovePlaylist(playlist);
        }
